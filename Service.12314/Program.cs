...
lifetime.ApplicationStarted.Register(() =>
{
    ...
    {
        ID = "ASPNETCore-Service-12314-ID", // 服务实例唯一 ID
        Name = "ASPNETCore-Service-12314-Name",                 // 服务名称
        Address = uri.Host,                 // 服务 IP 地址
        Port = uri.Port,                    // 服务端口
        Tags = new[] { "APIService", "api" },// 服务标签
...
{
    // 在应用停止时注销服务
    consulClient.Agent.ServiceDeregister("ASPNETCore-Service-12314-ID").Wait();
});
