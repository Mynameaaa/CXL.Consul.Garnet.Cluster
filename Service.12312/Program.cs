...
{
    "http://192.168.2.95:8500",
    "http://192.168.2.96:8510",
    "http://192.168.2.97:8520"
};
...
lifetime.ApplicationStarted.Register(() =>
{
    ...
    {
        ID = "ASPNETCore-Service-12312-2", // 服务实例唯一 ID
        Name = "ASPNETCore-Service-12312-Name",                 // 服务名称
        Address = uri.Host,                 // 服务 IP 地址
        Port = uri.Port,                    // 服务端口
        Tags = new[] { "TestAPISerivce", "api" },// 服务标签
        Check = new AgentServiceCheck
        {
            HTTP = $"http://192.168.2.88:5000/health", // 健康检查的 HTTP 地址
...
{
    // 在应用停止时注销服务
    consulClient.Agent.ServiceDeregister("ASPNETCore-Service-12312-ID").Wait();
});
...
app.Run("http://192.168.2.88:5000");
